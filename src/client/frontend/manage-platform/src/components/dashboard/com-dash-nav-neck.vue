    ...
    <div class="nav-neck">
        <div style="float: left;width: 100%">
            <el-menu class="nav-menu" mode="horizontal"
                ...
                <router-link class="router-link" to="/dashboard/role-admin"
                             v-if="role_show.indexOf(app_settings.role_admin) > -1">
                    <el-menu-item index="RoleAdmin">角色管理</el-menu-item>
                </router-link>
                <router-link class="router-link" to="/dashboard/user-admin"
                             v-if="role_show.indexOf(app_settings.role_admin) > -1">
                    <el-menu-item index="UserAdmin">用户管理</el-menu-item>
                </router-link>
                <router-link class="router-link" :to="{name: 'Transform',params: { goto: 'mutual'}}"
                    ...
                    <el-menu-item index="Transform">转入交互台</el-menu-item>
                </router-link>
                <div class="user-area"
