...
class AppSettings {
    constructor() {
        ...
        this.user_path = "api/dashboard/admin-space/user/";
        this.login_path = "api/dashboard/admin-space/login/";

        this.role_path = "api/dashboard/support-space/role/";
        this.company_path = "api/dashboard/company-space/";
